package com.om.diucampusschedule.core.work
...
class SaveNotificationWorker @AssistedInject constructor(
    ...
    override suspend fun doWork(): Result {
        return try {
            ...
            logger.debug(TAG, "Starting background notification save: $title")
            ...
            logger.error(TAG, "Background notification save failed", e)
            Result.retry()
        }
    }
}